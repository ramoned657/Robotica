\begin{titlepage}
	...
	\begin{tabular}{@{}p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}@{}}
		\includegraphics[height=2cm]{portada/tecnm.eps} & 
		\centering \includegraphics[height=1.5cm]{portada/SEP} & 
		\raggedleft \includegraphics[height=2cm]{portada/ith.jpg} \\
	\end{tabular}
